...
query = "What are the current assets and current liabilities for the recent most year in the document? Now calculate the current ratio using the above current assets and liabilities."
